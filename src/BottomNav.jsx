...
export function getLang() {
  return localStorage.getItem('lang') || LANGS.TH
}
...
export const T = {
  ...
  aliasHint:        { th: 'คั่นด้วยจุลภาค เช่น ออย,oy', en: 'Comma separated e.g. oy,อ้อย' },
  ...
  addDirectDebt:    { th: '💸 หนี้โดยตรง',      en: '💸 Direct Debt' },
  ...
  debtor:           { th: 'ผู้เป็นหนี้',          en: 'Debtor' },
  creditor:         { th: 'ผู้รับเงิน',           en: 'Creditor' },
