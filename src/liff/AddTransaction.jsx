...
import { fetchSheet, sendToGAS, todayISO } from './utils'

const S = {
  wrap:    { maxWidth: 480, margin: '0 auto', padding: '0 0 80px', fontFamily: 'system-ui,sans-serif' },
  header:  { background: '#1D9E75', color: '#fff', padding: '16px 20px' },
...
export default function AddTransaction() {
  ...
  return (
    <div style={S.wrap}>
      ...
      <div style={S.footer}>
        <button onClick={handleSave} style={saving ? S.btnDis : S.btnSave} disabled={saving}>
